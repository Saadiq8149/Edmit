    ...
    <div className="relative min-h-screen">
      ...
      <main className="container py-8 relative z-10">
        <motion.div
          ...
          className="banner relative rounded-xl overflow-hidden mb-8 bg-gradient-to-r from-primary/80 to-primary p-8 shadow-lg"
        >
          <div className="banner-content relative z-10">
            <h1 className="text-4xl font-bold mb-3 text-white">Explore Colleges</h1>
            <p className="text-white/90 text-lg">Discover top medical colleges across India for your NEET journey</p>

            <div className="mt-4 flex flex-wrap gap-2">
              {/* <Badge variant="secondary" className="bg-white/20 hover:bg-white/30 text-white border-none backdrop-blur-sm">
                <Sparkles className="w-3 h-3 mr-1" /> NEET-UG Counselling 2025
              </Badge> */}
              <Badge variant="secondary" className="bg-white/20 hover:bg-white/30 text-white border-none backdrop-blur-sm">
        ...
        >
          <div className="flex flex-col md:flex-row gap-4">
            <div className="w-full md:w-64">
              <label htmlFor="state-select" className="block text-sm font-medium text-gray-700 mb-1">Filter by State</label>
              <Select
                value={selectedState}
                onValueChange={(value) => {
              ...
              >
                <SelectTrigger id="state-select" className="bg-white/80">
            ...
            <div className="flex-1">
              <label htmlFor="college-search" className="block text-sm font-medium text-gray-700 mb-1">Search Colleges</label>
        ...
        {isLoading ? (
          <div className="flex flex-col justify-center items-center h-60 bg-white/50 rounded-xl shadow-sm p-8">
            ...
            <p className="text-muted-foreground mt-4">Discovering colleges for you...</p>
          </div>
          ...
          <>
            ...
            {totalPages > 1 && (
              <motion.div
                ...
                className="flex justify-center items-center gap-2 mt-10 mb-2"
              >
                <Button
                  variant="outline"
                  size="sm"
                ...
                {getPageNumbers().map((page, index) => (
                  typeof page === 'number' ? (
                    <Button
                      ...
                      className={currentPage === page ? "" : "bg-white/80"}
                    >
                      {page}
                    </Button>
                  ) : (
